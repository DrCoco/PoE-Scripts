...
# This script was built to calcualte the profit margins for 5/6 linking all weapons via Jeweller's Touch and Fated Connections prophecy
...
response = requests.get("https://poe.ninja/api/data/itemoverview?league=" + settings.league + "&type=UniqueWeapon&language=en")
response.text
